...
export const PRIMARY = '#070F6A'
export const SECONDARY = '#0E4B75'
export const ACCENT_GREEN = '#F94B1E'
export const ACCENT_ORANGE = '#F94B1E'
export const ACCENT_RED = '#F94B1E'
export const ACCENT_MINT = '#F94B1E'
...
export const BUTTON_DEFAULT_UP = '#FFFFFF'
export const BUTTON_DEFAULT_UP_TEXT = '#0E4B75'
export const BUTTON_DEFAULT_DOWN = '#FFFFFF'
